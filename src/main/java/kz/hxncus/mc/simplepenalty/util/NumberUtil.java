...
public class NumberUtil {
    private final String IS_NOT_A_VALID_NUMBER = " is not a valid number.";
    ...
    private String getMantissa(final String str, final int stopPos) {
    ...
    public boolean isDigits(final String str) {
    ...
    private boolean isZero(final String mant, final String dec) {
